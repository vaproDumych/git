...
<?php if ($j3->settings->get('pageTitlePosition') === 'top'): ?>
  <h1 class="title page-title"><span><?php echo $text_edit_address; ?></span></h1>
<?php endif; ?>
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>">
      <?php if ($j3->settings->get('pageTitlePosition') === 'default'): ?>
        <h1 class="title page-title"><?php echo $text_edit_address; ?></h1>
      <?php endif; ?>
      <?php echo $content_top; ?>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <div id="address">
          <div class="form-group <?php if ($j3->settings->get('accountAddressFirstNameField') === 'required'): ?>required<?php endif; ?> address-firstname">
          ...
          <div class="form-group <?php if ($j3->settings->get('accountAddressLastNameField') === 'required'): ?>required<?php endif; ?> address-lastname">
