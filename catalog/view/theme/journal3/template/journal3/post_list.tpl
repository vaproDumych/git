    ...
    <div class="post-thumb">
      ...
      <div class="caption">
        ...
        <div class="button-group">
          <a class="btn btn-read-more" href="<?php echo $post['href']; ?>" <?php if (($j3->settings->get('PostListButtonDisplay') == "icon") && ($j3->settings->get('PostListButtonTooltipStatus'))): ?>data-toggle="tooltip" data-tooltip-class="<?php echo $module_id ? 'module-blog_posts-' . $module_id . ' module-blog_posts-grid' : 'post-grid'; ?> read-more-tooltip" data-placement="<?php echo $j3->settings->get('PostListButtonTooltipPosition'); ?>" title="<?php echo $j3->settings->get('blogReadMoreButtonText'); ?>" <?php endif; ?>>
