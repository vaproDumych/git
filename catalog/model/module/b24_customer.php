...
class ModelModuleB24Customer extends Model
{
	...
	public function addToDB( $customerId, $b24Id, array $fields = [])
	{
		...
		$fieldsToAdd = ['oc_customer_id' => $customerId, 'b24_contact_id' => $b24Id, 'b24_contact_field' => $fields];
	...
	public function addCustomer( $customerId )
	{
		...
		$contact = $this->model_module_b24_order->getB24ContactList(['EMAIL' => $email])[0];
