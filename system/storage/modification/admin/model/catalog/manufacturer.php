...
class ModelCatalogManufacturer extends Model {
	...
	public function getManufacturer($manufacturer_id) {
		$query = $this->db->query("SELECT DISTINCT *, (SELECT keyword FROM " . DB_PREFIX . "seo_url_alias WHERE query = 'manufacturer_id=" . (int)$manufacturer_id . "' and language_id=" . $this->config->get('config_language_id') . " LIMIT 1) AS keyword FROM " . DB_PREFIX . "manufacturer WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
