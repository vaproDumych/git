...
class ModelCatalogInformation extends Model {
	...
	public function getInformation($information_id) {
		$query = $this->db->query("SELECT DISTINCT *, (SELECT keyword FROM " . DB_PREFIX . "seo_url_alias WHERE query = 'information_id=" . (int)$information_id . "'  and language_id=" . $this->config->get('config_language_id') . " LIMIT 1) AS keyword FROM " . DB_PREFIX . "information WHERE information_id = '" . (int)$information_id . "'");
