...
final class Loader {
 ...
 if (function_exists('Wkh') and !empty($route) and Wkh($route)) return; //Lightning 
		// Sanitize the call
 ...
 if (isset($registry) && !$result && function_exists('Wfn')) if (($res = Wfn($route, $args)) !== -1) { return $res; } //Lightning 
