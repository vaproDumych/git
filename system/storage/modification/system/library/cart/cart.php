...
class Cart {
	...
	public function __construct($registry) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "cart WHERE (api_id > '0' OR customer_id = '0') AND date_added < DATE_SUB(NOW(), INTERVAL 1 HOUR)");
		 ...
		 if ($this->customer->getId() and !defined("Wfd"))  {
 ...
 global $li_cpr; if (is_array($li_cpr)) return $li_cpr; else $li_cpr = 1; //Lightning 
		$product_data = array();
 ...
 if (isset($li_cpr)) $li_cpr = $product_data; //Lightning 
		return $product_data;
	}

	public function add($product_id, $quantity = 1, $option = array(), $recurring_id = 0) {
 global $li_cpr; $li_cpr = 0; //Lightning 
 ...
 global $li_cpr; $li_cpr = 0; if (function_exists('Wbr')) Wbr(); //Lightning 
