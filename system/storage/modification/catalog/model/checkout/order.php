	...
	public function addOrder($data) {
		...
		if (isset($data['totals'])) {
			foreach ($data['totals'] as $total) {
                ...
                $bitrix24login = "+380982716878"; // Укажите логин аккаунта для добавления лида
                $bitrix24password = "0932520560"; // Укажите пароль аккаунта для добавления лида
                $bitrix24domen = "b24-t6fxf1.bitrix24.ua"; // Укажите домен вашего битрикса
