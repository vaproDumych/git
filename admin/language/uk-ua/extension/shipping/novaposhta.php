<?php
// Heading
$_['heading_title']    						 = 'Нова Пошта API <a href="http://prowebber.ru" target="_blank" title="prowebber.ru" style="color:#0362B6;margin-right:5px"><i class="fa fa-cloud-download fa-fw"></i></a> ';
$_['heading_applying_api_key']				 = 'Застосування ключа API <a href="http://prowebber.ru" target="_blank" title="prowebber.ru" style="color:#0362B6;margin-right:5px"><i class="fa fa-cloud-download fa-fw"></i></a> ';
...
$_['column_weight']           				 = 'Вага (включно), кг';
...
$_['column_pickup_or_deliver']        	     = 'Забір або доставка';
$_['column_pickup_and_deliver']        	     = 'Забір та доставка';
...
$_['column_backward_shipping']         		 = 'Зворотна доставка';
...
$_['help_api_calculation'] 					 = 'Розрахунок вартості через API «Нової Пошти» - дає найбільш точні та актуальні дані про вартість доставки';
...
$_['help_update_areas'] 					 = 'Буде виконано оновлення списку областей поштової компанії. Дія не вплине на стандартні області';
...
$_['help_update_references']				 = 'Буде виконано оновлення довідникової та іншої інформації поштової компанії необхідної для роботи доповнення. Рекомендована частота оновлень не рідше 1-го разу на місяць';
...
$_['help_departure_additional_information']  = 'Використовується як шаблон для поля додаткової інформації про відправлення при створенні «ЕН». Можливе застосування макросів. При використанні макросів товару розділяйте текст на два блоки за допомогою символу «|» (макроси товару використовуйте в другому блоці)';
...
$_['text_document_and_parcel_tariffs'] 		 = 'Тариф на відправлення документів та посилок';
...
$_['error_empty_field'] 					 = 'Поле обов`язкове до заповнення!';
