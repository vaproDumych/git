...
function deleteAutoLink(id) {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            if (result) {
                $.ajax({
                    url: "index.php?route=" + modulePath + "/remove_autolink&" + token_string + "=" + token + "&id=" + id,
                    type: 'get',
                    dataType: 'JSON',
                    beforeSend: function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                $.ajax({
                    url: "index.php?route=" + modulePath + "/add_autolink&" + token_string + "=" + token,
                    type: 'get',
...
function editAutoLink(id, page) {
    $.ajax({
        url: "index.php?route=" + modulePath + "/get_autolink&" + token_string + "=" + token + "&id=" + id,
        type: 'get',
        dataType: 'JSON',
        beforeSend: function() {
        },
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    ...
                    if (result) {
                        ...
                        $.ajax({
                            url: "index.php?route=" + modulePath + "/edit_autolink&" + token_string + "=" + token + "&id=" + id,
                            type: 'get',
                            data: $('.autolink-submit-form').find('input').serialize(),
                            dataType: 'JSON',
                            beforeSend: function() {
    ...
    if (links.length > 0) {
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    $.ajax({
                        url: "index.php?route=" + modulePath + "/remove_autolinks&" + token_string + "=" + token,
                        type: 'POST',
