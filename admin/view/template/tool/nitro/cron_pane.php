...
<table class="form settings">
  ...
  <tr>
    ...
    <td>
        ...
        <div>
            <input class="form-control" type="checkbox" name="Nitro[CRON][Local][PreCache]" <?php if (!empty($nitroData['Nitro']['CRON']['Local']['PreCache'])) echo 'checked="checked"'; ?> value="1" /> Pre-Cache common pages: home page, categories (up to level 3), information pages, special offers.
        </div>
        <div>
  ...
  <tr>
    ...
    <td>
        <input class="form-control" type="input" name="Nitro[CRON][Local][PHPBinary]" value="<?php echo !empty($nitroData['Nitro']['CRON']['Local']['PHPBinary']) ? $nitroData['Nitro']['CRON']['Local']['PHPBinary'] : "/usr/bin/env php"; ?>" />
    </td>
  </tr>
...
<table class="form settings">
  ...
  <tr>
    ...
    <td>
        ...
        <div>
            <input class="form-control" type="checkbox" name="Nitro[CRON][Remote][PreCache]" <?php if (!empty($nitroData['Nitro']['CRON']['Remote']['PreCache'])) echo 'checked="checked"'; ?> value="1" /> Pre-Cache common pages: home page, categories (up to level 3), information pages, special offers.
        </div>
        <div>
