    ...
    <div class="tab-pane" id="tab-attribute">
      ...
      <table id="attributeFields" class="table table-bordered">
        ...
        <tr>
          ...
          <td><input type="text" name="attribute_fields[group]" class="form-control" value="<?php echo isset($profile['attribute_fields']['group']) ? $profile['attribute_fields']['group'] : ''; ?>"/></td>
          <td><input type="text" name="attribute_fields_default[group]" class="form-control" value="<?php echo isset($profile['attribute_fields_default']['group']) ? $profile['attribute_fields_default']['group'] : ''; ?>"/></td>
        </tr>
        <tr>
          <td>Attribute name</td>
          <td><input type="text" name="attribute_fields[name]" class="form-control" value="<?php echo isset($profile['attribute_fields']['name']) ? $profile['attribute_fields']['name'] : ''; ?>"/></td>
          <td><input type="text" name="attribute_fields_default[name]" class="form-control" value="<?php echo isset($profile['attribute_fields_default']['name']) ? $profile['attribute_fields_default']['name'] : ''; ?>"/></td>
        </tr>
        <tr>
          <td>Value</td>
          <td><input type="text" name="attribute_fields[value]" class="form-control" value="<?php echo isset($profile['attribute_fields']['value']) ? $profile['attribute_fields']['value'] : ''; ?>"/></td>
          <td><input type="text" name="attribute_fields_default[value]" class="form-control" value="<?php echo isset($profile['attribute_fields_default']['value']) ? $profile['attribute_fields_default']['value'] : ''; ?>"/></td>
        </tr>
        <?php /*
