...
<br />
<table class="table table-striped table-editor table-editor-informations" data-type="information" data-language-id="<?php echo $language_id; ?>"> 
    <thead>
        <tr> 
        ...
        <tr class="filter-informations filter-form" data-route="editor_informations" data-view="editor-informations"> 
            ...
            <th class="text-right">
                ...
                <a onClick="filterData('.filter-informations');" class="btn btn-primary"><?php echo $text_filter; ?></a>
            </th>
        </tr>
    </thead> 
    <tbody> 
        <?php if (count($sources)>0) { ?>   
            ...
            <tr> 
                ...
                <td id="information_seo_keyword_<?php echo $result['information_id']; ?>" onDblClick="editField(<?php echo $result['information_id']; ?>, 'url_alias', this);"><span class="editable"><?php echo $result['seo_keyword']; ?></span></td> 
                <td id="information_meta_title_<?php echo $result['information_id']; ?>" onDblClick="editField(<?php echo $result['information_id']; ?>, 'meta_title', this);"><span class="editable"><?php echo $result['meta_title']; ?></span></td> 
                <td id="information_meta_description_<?php echo $result['information_id']; ?>" onDblClick="editField(<?php echo $result['information_id']; ?>, 'meta_description', this);"><span class="editable"><?php echo $result['meta_description']; ?></span></td> 
                <td id="information_meta_keyword_<?php echo $result['information_id']; ?>"onDblClick="editField(<?php echo $result['information_id']; ?>, 'meta_keyword', this);"><span class="editable"><?php echo $result['meta_keyword']; ?></span></td>
                <td></td> 
                <td></td> 
            </tr> 
            <?php } ?>
