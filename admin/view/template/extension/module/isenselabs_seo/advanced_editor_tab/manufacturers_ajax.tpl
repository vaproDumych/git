...
<br />
<table class="table table-striped table-editor table-editor-manufacturers" data-type="manufacturer" data-language-id="<?php echo $language_id; ?>"> 
    <thead>
        <tr> 
        ...
        <tr class="filter-manufacturers filter-form" data-route="editor_manufacturers" data-view="editor-manufacturers"> 
            ...
            <th class="text-right">
                ...
                <a onClick="filterData('.filter-manufacturers');" class="btn btn-primary"><?php echo $text_filter; ?></a>
            </th>
        </tr>
    </thead> 
    <tbody> 
        <?php if (count($sources)>0) { ?>   
            ...
            <tr> 
                ...
                <td id="manufacturer_seo_keyword_<?php echo $result['manufacturer_id']; ?>" onDblClick="editField(<?php echo $result['manufacturer_id']; ?>, 'url_alias', this);"><span class="editable"><?php echo $result['seo_keyword']; ?></span></td> 
                <td id="manufacturer_meta_title_<?php echo $result['manufacturer_id']; ?>" onDblClick="editField(<?php echo $result['manufacturer_id']; ?>, 'meta_title', this);"><span class="editable"><?php echo $result['meta_title']; ?></span></td> 
                <td id="manufacturer_meta_description_<?php echo $result['manufacturer_id']; ?>" onDblClick="editField(<?php echo $result['manufacturer_id']; ?>, 'meta_description', this);"><span class="editable"><?php echo $result['meta_description']; ?></span></td> 
                <td id="manufacturer_meta_keyword_<?php echo $result['manufacturer_id']; ?>"onDblClick="editField(<?php echo $result['manufacturer_id']; ?>, 'meta_keyword', this);"><span class="editable"><?php echo $result['meta_keyword']; ?></span></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr> 
            <?php } ?>
