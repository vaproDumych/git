					...
					<div class="row">
						<div class="col-sm-6">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-sender_contact_person"><?php echo $entry_contact_person; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-sender_contact_person_phone"><?php echo $entry_phone; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-sender_city_name"><?php echo $entry_city; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-sender_address_name"><?php echo $entry_address; ?></label>
										<div class="col-sm-10">
						...
						<div class="col-sm-6">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-recipient_name"><?php echo $entry_recipient; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-recipient_contact_person"><?php echo $entry_contact_person; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-recipient_contact_person_phone"><?php echo $entry_phone; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group" style="display: none">
										<label class="col-sm-2 control-label" for="input-recipient_area"><?php echo $entry_area; ?></label>
										<div class="col-sm-10">
											...
											<input type="hidden" name="recipient_area_name" value="<?php echo $recipient_area_name; ?>" id="input-recipient_area_name" />
											<input type="hidden" name="recipient_region_name" value="<?php echo $recipient_region_name; ?>" id="input-recipient_region_name" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-recipient_city_name"><?php echo $entry_city; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-recipient_warehouse_name"><?php echo $entry_warehouse; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group" style="display: none">
										<label class="col-sm-2 control-label" for="input-recipient_street_name"><?php echo $entry_street; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group" style="display: none">
										<label class="col-sm-2 control-label" for="input-recipient_house"><?php echo $entry_house; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group" style="display: none">
										<label class="col-sm-2 control-label" for="input-recipient_flat"><?php echo $entry_flat; ?></label>
										<div class="col-sm-10">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-departure_type"><?php echo $entry_departure_type; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group" style="display: none;">
										<label class="col-sm-2 control-label" for="input-tires_and_wheels_<?php echo $t_and_w['Ref']; ?>"><?php echo $t_and_w['Description']; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-volume_general"><?php echo $entry_volume_general; ?></label>
										<div class="col-sm-10">
											<div class="input-group">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-volume_weight"><?php echo $entry_volume_weight; ?></label>
										<div class="col-sm-10">
											<div class="input-group">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-seats_amount"><?php echo $entry_seats_amount; ?></label>
										<div class="col-sm-10">
											<div class="input-group">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-announced_price"><?php echo $entry_announced_price; ?></label>
										<div class="col-sm-10">
											<div class="input-group">
												<span class="input-group-btn">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-departure_description"><?php echo $entry_departure_description; ?></label>
										<div class="col-sm-10">
						...
						<div class="col-sm-6">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-payer"><?php echo $entry_payer; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group" style="display: none">
										<label class="col-sm-2 control-label" for="input-third_person"><?php echo $entry_third_person; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<select name="payment_type" id="input-payment_type" class="form-control">
												...
												<?php if ($v['Ref'] == 'NonCash' && empty($sender_options['CanNonCashPayment'])) { ?>
												<option value="<?php echo $v['Ref']; ?>" disabled><?php echo $v['Description']; ?></option>
												<?php } elseif ($v['Ref'] == $payment_type) { ?>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-backward_delivery"><?php echo $entry_backward_delivery; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group" style="display: none">
										<label class="col-sm-2 control-label" for="input-backward_delivery_total"><?php echo $entry_backward_delivery_total; ?></label>
										<div class="col-sm-10">
											<div class="input-group">
									...
									<div class="form-group"<?php if (empty($sender_options['CanAfterpaymentOnGoodsCost'])) { echo ' style="display: none"'; } ?>>
									...
									<div class="form-group" style="display: none">
										<label class="col-sm-2 control-label" for="input-backward_delivery_payer"><?php echo $entry_backward_delivery_payer; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group" style="display: none">
										<label class="col-sm-2 control-label" for="input-money_transfer_method"><?php echo $entry_money_transfer_method; ?></label>
										<div class="col-sm-10">
									...
									<div class="form-group" style="display: none">
										<label class="col-sm-2 control-label" for="input-payment_card"><?php echo $entry_payment_card; ?></label>
										<div class="col-sm-10">
						...
						<div class="col-sm-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="col-sm-6">
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-departure_date"><?php echo $entry_departure_date; ?></label>
											<div class="col-sm-10">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-preferred_delivery_date"><?php echo $entry_preferred_delivery_date; ?></label>
											<div class="col-sm-10">
												<div class="input-group date">
										...
										<div class="form-group" style="display: none">
											<label class="col-sm-2 control-label" for="input-time_interval"><?php echo $entry_preferred_delivery_time; ?></label>
											<div class="col-sm-10">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-packing_number"><?php echo $entry_packing_number; ?></label>
											<div class="col-sm-10">
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-additional_information"><?php echo $entry_departure_additional_information; ?></label>
											<div class="col-sm-10">
