	...
	<div class="page-header">
		<div class="container-fluid">
			...
			<div class="pull-right">
				...
				<button type="button" id="button-delete" onclick="confirm('<?php echo $text_confirm; ?>') ? deleteCN(this) : false;" data-toggle="tooltip" data-value="" title="<?php echo $button_delete; ?>" class="btn btn-danger" disabled="disabled"><i class="fa fa-trash-o"></i></button>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<?php } ?>
									<?php if (in_array('backward_shipping', $displayed_information)) { ?>
									<td><?php echo $column_backward_shipping; ?></td>
									<?php } ?>
							...
							<?php if ($cns) { ?>
								<?php foreach ($cns as $cn) { ?>
									...
									<?php } ?>
											...
											<?php } ?>
											<?php if (in_array('backward_shipping', $displayed_information)) { ?>
											<td><?php echo $cn['backward_shipping']; ?></td>
											<?php } ?>
											<?php if (in_array('service_type', $displayed_information)) { ?>
											...
											<td class="text-center">
												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu dropdown-menu-right">
														...
														<li><a onclick="confirm('<?php echo $text_confirm; ?>') ? deleteCN(this) : false;" style="cursor: pointer;"><i class="fa fa-trash-o text-danger fa-fw"></i> <?php echo $text_delete; ?></a></li>
													</ul>
												</div>
											</td>
										</tr>
