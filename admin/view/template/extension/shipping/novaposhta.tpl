			...
			<div class="pull-right">
				<div class="btn-group">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						<li><a onclick="$('#form-novaposhta').submit();" style="cursor: pointer;"><i class="fa fa-sign-out fa-fw" aria-hidden="true"></i> <?php echo $button_save_and_exit; ?></a></li>
 	...
 	<div class="container-fluid">
    	...
    	<div class="panel panel-default">
      		...
      		<div class="panel-body">
        		<form action="<?php echo $save_and_exit; ?>" method="post" enctype="multipart/form-data" id="form-novaposhta" class="form-horizontal">
					...
					<div class="tab-content">
						...
						<div class="tab-pane fade<?php if ($license) { ?>in active<?php } ?>" id="tab-general">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab-global">
			            				...
			            				<div class="form-group required">
					          			...
					          			<div class="form-group">
					            			<label class="col-sm-2 control-label" for="button-tariffs"><span data-toggle="tooltip" title="<?php echo $help_tariffs; ?>"><?php echo $entry_tariffs; ?></span></label>
					            			<div class="col-sm-1">
					              				<a class="btn btn-primary btn-block" data-toggle="tooltip" title="<?php echo $button_tariffs; ?>" id="button-tariffs" role="button"><i class="fa fa-calculator"></i></a>
					            			</div>
					          			</div>
			            				<div class="form-group">
									...
									<div class="tab-pane fade" id="tab-warehouse">
			                    		...
			                    		<div class="form-group">
			                    			<label class="col-sm-2 control-label" for="input-warehouse_deliver_period-enabled"><span data-toggle="tooltip" title="<?php echo $help_delivery_period; ?>"><?php echo $entry_delivery_period; ?></span></label>
			                    			<div class="col-sm-2">
				      							<div class="radio-switch">
				      							<?php if ($novaposhta['shipping_methods']['warehouse']['delivery_period']) { ?>
									                <input type="radio" name="novaposhta[shipping_methods][warehouse][delivery_period]" value="0" id="input-warehouse_deliver_period-disabled">
			                                        <label class="col-sm-4" for="input-warehouse_deliver_period-enabled"><?php echo $text_no; ?></label>
				      								<input type="radio" name="novaposhta[shipping_methods][warehouse][delivery_period]" value="1" id="input-warehouse_deliver_period-enabled" checked>
			                                        <label class="col-sm-4" for="input-warehouse_deliver_period-disabled"><?php echo $text_yes; ?></label>
									                <?php } else { ?>
			                                        <input type="radio" name="novaposhta[shipping_methods][warehouse][delivery_period]" value="0" id="input-warehouse_deliver_period-disabled" checked>
			                                        <label class="col-sm-4" for="input-warehouse_deliver_period-enabled"><?php echo $text_no; ?></label>
			                                        <input type="radio" name="novaposhta[shipping_methods][warehouse][delivery_period]" value="1" id="input-warehouse_deliver_period-enabled">
			                                        <label class="col-sm-4" for="input-warehouse_deliver_period-disabled"><?php echo $text_yes; ?></label>
									            <?php } ?>
				      							</div>
				      						</div>
		            				...
		            				<div class="tab-pane" id="tab-doors">
			                    		...
			                    		<div class="form-group">
			                    			<label class="col-sm-2 control-label" for="input-doors_deliver_period-enabled"><span data-toggle="tooltip" title="<?php echo $help_delivery_period; ?>"><?php echo $entry_delivery_period; ?></span></label>
			                    			<div class="col-sm-2">
				      							<div class="radio-switch">
				      							<?php if ($novaposhta['shipping_methods']['doors']['delivery_period']) { ?>
									                <input type="radio" name="novaposhta[shipping_methods][doors][delivery_period]" value="0" id="input-doors_deliver_period-disabled">
			                                        <label class="col-sm-4" for="input-doors_deliver_period-enabled"><?php echo $text_no; ?></label>
				      								<input type="radio" name="novaposhta[shipping_methods][doors][delivery_period]" value="1" id="input-doors_deliver_period-enabled" checked>
			                                        <label class="col-sm-4" for="input-doors_deliver_period-disabled"><?php echo $text_yes; ?></label>
									                <?php } else { ?>
			                                        <input type="radio" name="novaposhta[shipping_methods][doors][delivery_period]" value="0" id="input-doors_deliver_period-disabled" checked>
			                                        <label class="col-sm-4" for="input-doors_deliver_period-enabled"><?php echo $text_no; ?></label>
			                                        <input type="radio" name="novaposhta[shipping_methods][doors][delivery_period]" value="1" id="input-doors_deliver_period-enabled">
			                                        <label class="col-sm-4" for="input-doors_deliver_period-disabled"><?php echo $text_yes; ?></label>
									            <?php } ?>
				      							</div>
				      						</div>
          				...
          				<div class="tab-pane fade" id="tab-recipient">
              				...
              				<div class="form-group">
            					...
            					<div class="col-sm-10">
              						<input type="text" name="novaposhta[recipient_area]" value="<?php echo $novaposhta['recipient_area']; ?>" placeholder="<?php echo $entry_area; ?>" id="input-recipient_area" class="form-control" />
              					</div>
              				</div>
              				<div class="form-group">
						...
						<div class="tab-pane fade" id="tab-consignment_note">
          				...
          				<div class="tab-pane fade" id="tab-cron">
          					...
          					<div class="form-group">
            					<label class="col-sm-2 control-label" for="input-cron_update_areas"><?php echo $entry_area; ?></label>
            					<div class="col-sm-10">
									<div class="input-group">
										<input type="text" value="<?php echo $cron_update_areas; ?>"  id="input-cron_update_areas" class="form-control" readonly />
										<span class="input-group-btn">
											<button class="btn btn-default" type="button" data-toggle="tooltip" title="<?php echo $button_copy; ?>" onclick="copyToClipboard('input-cron_update_areas');"><i class="fa fa-files-o" aria-hidden="true"></i></button>
										</span>
									</div>
              					</div>
              				</div>
					        ...
					        <div class="panel panel-default">
								...
								<div class="table-responsive">
					            	<table class="table table-bordered table-hover" id="table-tracking_statuses">
					              		<thead>
					                		<tr>
					                  			<td class="text-center" width="15%"><?php echo $column_novaposhta_status; ?></td>
					...
					<div class="modal fade" id="modal-edit-tariffs" tabindex="-1" role="dialog" aria-labelledby="modal-edit-tariffs-label">
						  <div class="modal-dialog modal-lg" role="document">
						    <div class="modal-content">
						      	<div class="modal-header">
						        	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						        	<h4 class="modal-title" id="modal-edit-tariffs-label"><?php echo $heading_tariff; ?></h4>
						      	</div>
							    <div class="modal-body">
							      	<div class="form-group">
				            			<label class="col-sm-3 control-label" for="input-tariffs-discount"><span data-toggle="tooltip" title="<?php echo $help_discount; ?>"><?php echo $entry_discount; ?></span></label>
				            			<div class="col-sm-9">
					            			<div class="input-group">
				              					<input type="text" name="novaposhta[tariffs][discount]" value="<?php echo $novaposhta['tariffs']['discount']; ?>" placeholder="<?php echo $entry_discount; ?>" id="input-tariffs-discount" class="form-control" />
				              					<span class="input-group-addon"><?php echo $text_pct; ?></span>
				              				</div>
			              				</div>
				          			</div>
				          			<div class="form-group">
				            			<label class="col-sm-3 control-label" for="input-tariffs-additional_commission"><span data-toggle="tooltip" title="<?php echo $help_additional_commission; ?>"><?php echo $entry_additional_commission; ?></span></label>
				            			<div class="col-sm-3">
					            			<div class="input-group">
				              					<input type="text" name="novaposhta[tariffs][additional_commission]" value="<?php echo $novaposhta['tariffs']['additional_commission']; ?>" placeholder="<?php echo $entry_additional_commission; ?>" id="input-tariffs-additional_commission" class="form-control" />
				              					<span class="input-group-addon"><?php echo $text_pct; ?></span>
				              				</div>
			              				</div>
			              				<label class="col-sm-3 control-label" for="input-tariffs-additional_commission_bottom"><span data-toggle="tooltip" title="<?php echo $help_additional_commission_bottom; ?>"><?php echo $entry_additional_commission_bottom; ?></span></label>
				            			<div class="col-sm-3">
					            			<div class="input-group">
				              					<input type="text" name="novaposhta[tariffs][additional_commission_bottom]" value="<?php echo $novaposhta['tariffs']['additional_commission_bottom']; ?>" placeholder="<?php echo $entry_additional_commission_bottom; ?>" id="input-tariffs-additional_commission_bottom" class="form-control" />
				              					<span class="input-group-addon"><?php echo $text_grn; ?></span>
				              				</div>
			              				</div>
				          			</div>
				          			<legend><?php echo $text_document_and_parcel_tariffs; ?></legend>
									<div class="table-responsive">
					            		<table class="table table-bordered table-hover" id="table-tariffs">
					              			<thead>
					                			<tr>
					                  				<td class="text-center" rowspan="2"><?php echo $column_weight; ?></td>
					                  				<td class="text-center"><?php echo $column_warehouse_service_cost; ?></td>
					                			...
					                			<tr>
													...
													<td class="text-center"><?php echo $column_pickup_or_deliver; ?></td>
													<td class="text-center"><?php echo $column_pickup_and_deliver; ?></td>
					                			</tr>
					              			</thead>
					              			<tbody>
					              			<?php if (isset($novaposhta['tariffs']['document_and_parcel']) && is_array($novaposhta['tariffs']['document_and_parcel'])) { $count = 0;?>
					              				<?php foreach ($novaposhta['tariffs']['document_and_parcel'] as $tariff) { ?>
					              				<tr>
					                  				<td><input type="text" name="novaposhta[tariffs][document_and_parcel][<?php echo $count; ?>][weight]" value="<?php echo $tariff['weight']; ?>" class="form-control" /></td>
					                  				<td><input type="text" name="novaposhta[tariffs][document_and_parcel][<?php echo $count; ?>][Ukraine]" value="<?php echo $tariff['Ukraine']; ?>" class="form-control" /></td>
													<td><input type="text" name="novaposhta[tariffs][document_and_parcel][<?php echo $count; ?>][overpay_doors_warehouse]" value="<?php echo $tariff['overpay_doors_warehouse']; ?>" class="form-control" /></td>
													<td><input type="text" name="novaposhta[tariffs][document_and_parcel][<?php echo $count; ?>][overpay_doors_doors]" value="<?php echo $tariff['overpay_doors_doors']; ?>" class="form-control" /></td>
					                  				<td class="text-center"><button type="button" onclick="$(this).parents('tr').remove();" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
					                			</tr>
					                			<?php $count++; } ?>
					                		<?php } ?>
...
function addTariff(tariff_name) {
    ...
    row += '<td><input type="text" name="novaposhta[tariffs][' + tariff_name + '][' + count + '][overpay_doors_warehouse]" value="" class="form-control" /></td>';
    row += '<td><input type="text" name="novaposhta[tariffs][' + tariff_name + '][' + count + '][overpay_doors_doors]" value="" class="form-control" /></td>';
