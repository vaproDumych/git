...
class ControllerExtensionModuleiSenseLabsSeo extends Controller {
	...
	public function index() {
        ...
        $this->data['enableMigrateOption'] = $this->moduleModel->seoUrlCheck();
        ...
        $this->data['unify_urls']                   = $this->moduleModel->getSetting('unify_urls');
        $this->data['breadcrumb_products']          = $this->moduleModel->getSetting('breadcrumb_products');
        $this->data['breadcrumb_categories']        = $this->moduleModel->getSetting('breadcrumb_categories');
        
        $this->data['url_product_autogenerate']     = $this->moduleModel->getSetting('url_product_autogenerate');
        $this->data['url_category_autogenerate']    = $this->moduleModel->getSetting('url_category_autogenerate');
        $this->data['url_manufacturer_autogenerate']= $this->moduleModel->getSetting('url_manufacturer_autogenerate');
        $this->data['url_information_autogenerate'] = $this->moduleModel->getSetting('url_information_autogenerate');
        
        $this->data['subfolder_prefixes']           = $this->moduleModel->getSetting('subfolder_prefixes');
        $this->data['subfolder_prefixes_alias']     = json_decode($this->moduleModel->getSetting('subfolder_prefixes_alias'), true);
        $this->data['default_lang_prefix']          = $this->moduleModel->getSetting('default_lang_prefix');
        $this->data['redirect_active_lang_prefix']  = $this->moduleModel->getSetting('redirect_active_lang_prefix');
        $this->data['cyrillic_urls']                = $this->moduleModel->getSetting('cyrillic_urls');
        $this->data['redirect_to_seo_links']        = $this->moduleModel->getSetting('redirect_to_seo_links');
    ...
    public function tab_titles() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/content_tab/tab_seo_titles.tpl', $this->data));
    }
    ...
    public function tab_descriptions() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/content_tab/tab_seo_descriptions.tpl', $this->data));
    }
    ...
    public function tab_keywords() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/content_tab/tab_seo_keywords.tpl', $this->data));
    }
    ...
    public function tab_product_heading_tags() {
        ...
        $this->data['seo_data']                 = $this->moduleModel->checkProductHeadingTagsCount();
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/content_tab/tab_seo_product_heading_tags.tpl', $this->data));
    }
    ...
    public function tab_image_titles() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/tab_image_names_ajax.tpl', $this->data));
    }
    ...
    public function tab_seo_links() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/urls_linking_tab/tab_seo_links.tpl', $this->data));
    }
    ...
    public function tab_home() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/tab_home.tpl', $this->data));
    }
    ...
    public function tab_autolinks() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/urls_linking_tab/autolinks_ajax.tpl', $this->data));
    }
    ...
    public function tab_richsnippets() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/tab_structured_data_ajax.tpl', $this->data));
    }
    ...
    public function tab_sociallinks() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/tab_social_seo_ajax.tpl', $this->data));
    }
    ...
    public function tab_htaccess() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/file_editor_tab/tab_htaccess.tpl', $this->data));
    }
    ...
    public function tab_robots() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/file_editor_tab/tab_robots.tpl', $this->data));
    }
    ...
    public function tab_customurls() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/urls_linking_tab/customurls_ajax.tpl', $this->data));
    }
    ...
    public function get_customurl() {
        ...
        $json       = array();
        $data       = $this->moduleModel->getCustomUrl($query);
        if ($data != false) {
            $json['success'] = true;
            $json['message'] = '';
            $json['data']    = $data;
    ...
    public function remove_customurl() {
        ...
        if ($this->moduleModel->deleteCustomUrl($query)) {
            $json['success'] = true;
            $json['message'] = '';
        } else {
            $json['error']   = $this->data['error_unexpected'];
    ...
    public function remove_customurls() {
        ...
        foreach ($queries as $query) {
            if (!$this->moduleModel->deleteCustomUrl($query['value'])) { 
                $flag = false;
            }
        }
    ...
    public function get_crawler_data() {
        require_once dirname(DIR_SYSTEM).'/vendors/isenselabs_seo/HtmlDom.php';
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/tab_crawler_results.tpl', $this->data));
    }
    ...
    public function tab_seo_analysis() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/tab_seo_analysis_ajax.tpl', $this->data));
    }
    ...
    public function editor_products() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/advanced_editor_tab/products_ajax.tpl', $this->data));
    }
    ...
    public function editor_categories() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/advanced_editor_tab/categories_ajax.tpl', $this->data));
    }
    ...
    public function editor_informations() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/advanced_editor_tab/informations_ajax.tpl', $this->data));
    }
    ...
    public function editor_manufacturers() {
        ...
        $this->response->setOutput($this->load->view($this->modulePath.'/advanced_editor_tab/manufacturers_ajax.tpl', $this->data));
    }
    ...
    public function tab_detected_missing_pages() {
        ...
        $this->data['total']        = $this->moduleModel->getTotalDetectedPages($filter_route, $visits, $date_start, $date_end);
        $this->data['limit']        = 10;
        ...
        $pagination->page			= $page;
        $pagination->limit			= $this->data['limit']; 
        $pagination->url			= $this->url->link($this->modulePath.'/tab_detected_missing_pages', $this->data['token_string'] . '=' . $this->data['token'] . '&page={page}' . $filter_url, 'SSL');

        $this->data['page']         = $page;
		$this->data['pagination']   = $pagination->render();
        $this->data['sources']      = $this->moduleModel->getDetectedPages($page, $this->data['limit'], $filter_route, $visits, $date_start, $date_end);

		$this->data['results']      = sprintf($this->language->get('text_pagination'), ($this->data['total']) ? (($page - 1) * $this->data['limit']) + 1 : 0, ((($page - 1) * $this->data['limit']) > ($this->data['total'] - $this->data['limit'])) ? $this->data['total'] : ((($page - 1) * $this->data['limit']) + $this->data['limit']), $this->data['total'], ceil($this->data['total'] / $this->data['limit']));
        
        $this->response->setOutput($this->load->view($this->modulePath.'/missing_pages_tab/detected_pages_ajax.tpl', $this->data));
    }
    ...
    public function clear_missing_pages() {
        ...
        if ($this->moduleModel->clearMissingPagesResults()) {
            $json['success'] = true;
            $json['message'] = '';
        } else {
            $json['error']   = $this->data['error_unexpected'];
    ...
    public function tab_redirects() {
        ...
        $this->data['total']        = $this->moduleModel->getTotalRedirects($route_from, $route_to);
        $this->data['limit']        = 10;
        ...
        $pagination->page			= $page;
        $pagination->limit			= $this->data['limit']; 
        $pagination->url			= $this->url->link($this->modulePath.'/tab_redirects', $this->data['token_string'] . '=' . $this->data['token'] . '&page={page}' . $filter_url, 'SSL');

        $this->data['page']         = $page;
		$this->data['pagination']   = $pagination->render();
        $this->data['sources']      = $this->moduleModel->getRedirects($page, $this->data['limit'], $route_from, $route_to);

		$this->data['results']      = sprintf($this->language->get('text_pagination'), ($this->data['total']) ? (($page - 1) * $this->data['limit']) + 1 : 0, ((($page - 1) * $this->data['limit']) > ($this->data['total'] - $this->data['limit'])) ? $this->data['total'] : ((($page - 1) * $this->data['limit']) + $this->data['limit']), $this->data['total'], ceil($this->data['total'] / $this->data['limit']));
        
        $this->response->setOutput($this->load->view($this->modulePath.'/missing_pages_tab/redirects_ajax.tpl', $this->data));
    }
