...
class ControllerExtensionHbseoHbSitemap extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/hbseo/hb_sitemap', 'token=' . $this->session->data['token'].'&store_id='.$data['store_id'], true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=hbseo', true)
		);

   		$data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('extension/hbseo/hb_sitemap', 'token=' . $this->session->data['token'].'&store_id='.$data['store_id'], true)
   		);
		
		$data['action'] = $this->url->link('extension/hbseo/hb_sitemap', 'token=' . $this->session->data['token'].'&store_id='.$data['store_id'], true);
		
		$data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=hbseo', true);
		...
		$this->response->setOutput($this->load->view('extension/hbseo/hb_sitemap', $data));
	}
	...
	public function customlinks() {  
		...
		$pagination->url = $this->url->link('extension/hbseo/hb_sitemap/customlinks', 'token=' . $this->session->data['token'] . '&store_id='.$store_id.'&page={page}', true);
		...
		$this->response->setOutput($this->load->view('extension/hbseo/hb_sitemap_misc_links', $data));
	}	
